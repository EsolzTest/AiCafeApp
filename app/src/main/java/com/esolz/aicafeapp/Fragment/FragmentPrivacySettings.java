...
public class FragmentPrivacySettings extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.frag_privacysettings, container, false);

        cd = new ConnectionDetector(getActivity());

        fragmentManager = getFragmentManager();

        sharedPreferencesSwitch = getActivity().getSharedPreferences("VISIBILITY", Context.MODE_PRIVATE);
        ...
        if (sharedPreferencesSwitch.getString("Visible", "").equals("OFF")) {
            switchNotification.setChecked(false);
        } else {
        ...
        txtPageTitle.setText("Privacy Setting");
    ...
    public void setPrivacySetting(final String URL, final String ID, final String visible) {
